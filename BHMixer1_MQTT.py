...
while True: 
  ...
  try:
    ...
    if (time.time() - last_message) > message_interval:
      ...
      #Statustxt
      msg = (Statustxt)# b'stelle waermer'
      client.publish(infotxt, msg)
      #last_message = time.time()
      #counter += 1  #anzahl der aufrufe
      #if counter >1:
          #print('sende')    
  except OSError as e:
    restart_and_reconnect()
